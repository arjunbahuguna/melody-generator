...
class MelodyPreprocessor:
    ...
    def create_training_dataset(self):
        ...
        flat_melodies = [note for melody in parsed_melodies for note in melody]
        self.tokenizer.fit(flat_melodies)
    ...
    def _parse_melody(self, melody):
        return [f"{note},{time}" for note, time in melody]
...
if __name__ == "__main__":
    preprocessor = MelodyPreprocessor("/home/melody-generator/ML/data", batch_size=1)
